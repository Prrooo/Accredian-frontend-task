...
const ReferSection = () => {
  ...
  return (
    <div className="flex flex-col items-center my-24 bg-primary-color-bg p-[2vw] h-[41vw] justify-between relative ">
      <h1 className="font-[600] text-3xl">
        How Do I <span className=" text-primary-color">Refer?</span>
      </h1>
      <div>
        <div className="absolute top-[15vw] left-[22.9vw] flex flex-col gap-[1.5vw] items-center text-center z-10 w-[13vw]">
          <svg
            width="88"
            height="67"
            viewBox="0 0 88 67"
          ...
          <p className="text-[1.05vw]/[1.4vw]">
            Submit referrals easily via our website’s referral section.
          </p>
        </div>

        <div className="absolute top-[15vw] left-[42.6vw] flex flex-col gap-[1.5vw] items-center text-center z-10 w-[13vw]">
          <svg
            width="66"
            height="68"
            viewBox="0 0 66 68"
          ...
          <div className="text-[1.05vw]/[1.4vw]">
            Earn rewards once your referral joins an Accredian program.
          </div>
        </div>

        <div className="absolute top-[15vw] right-[22.9vw] flex flex-col gap-[1.5vw] items-center text-center z-10 w-[13vw]">
          <svg
            width="65"
            height="68"
            viewBox="0 0 65 68"
          ...
          >
            ...
            />
            <path
              d="M35.0216 13.1051L35.1336 13.4637H36.9267C36.6914 13.1051 35.8957 12.9034 35.0216 13.1051Z"
              fill="#1A73E8"
            />
            <path
        ...
        <img
          className="absolute inset-0 -top-[2.5vw] mx-auto w-[72vw]"
          src="/images/referBg.png"
          alt="refImage"
        />
      </div>
      <button
